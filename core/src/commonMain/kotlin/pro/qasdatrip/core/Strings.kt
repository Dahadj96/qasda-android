    ...
    companion object {
        fun of(lang: Lang): Words = when (lang) {
            Lang.FR -> Words(
                ...
                stopsTwoPlus = "2 escales et plus", baggage = "Bagages", anyBaggage = "Cabine seule",
                navAccount = "Compte",
                ...
                airlinesOnRoute = "Compagnies sur ce trajet",
                fromPrice = "dès {price}", allAirlines = "Toutes",
                priceChart = "Graphique", priceByDate = "Prix par date",
                calendarTab = "Calendrier", bookingSites = "Sites de réservation",
                clearAll = "Tout effacer",
                bagHoldIncluded = "Bagage en soute inclus",
                bagHoldSub = "Masquer les tarifs sans bagage",
                markAllRead = "Tout lire",
                chartSub = "prix le plus bas par jour",
                chartLow = "Le plus bas", chartAvg = "Moyenne", chartHigh = "Le plus haut",
                chartNote = "Sur les derniers relevés. Un prix passé n\u2019est pas une promesse sur le prix de demain.",
                showOffers = "Voir les {n} offres",
                cheapestOver = "Le moins cher sur cette période",
                seeFlightsOn = "Voir les vols du {date}",
                offerDetails = "Détail de l\u2019offre", itinerary = "Itinéraire",
                cheaper = "moins cher", totalTime = "{duration} au total",
                sameFlightOn = "Le même vol sur {n} sites",
                statWatches = "suivis actifs", statNotifications = "notifications",
                statSearches = "recherches", currency = "Devise",
                currencyDzd = "Dinar algérien", homeAirport = "Aéroport de départ",
                notSet = "Non défini",
                timeNow = "à l\u2019instant", timeHours = "il y a {n} h",
                timeYesterday = "hier", timeDays = "il y a {n} j", timeWeeks = "il y a {n} sem",
                prefDrops = "Baisse de prix", prefDropsSub = "Quand un trajet suivi passe sous le prix vu",
                prefSeats = "Place libérée", prefSeatsSub = "Quand une place revient sur un vol complet",
                prefEnded = "Fin de suivi", prefEndedSub = "Quand la date d\u2019un suivi est passée",
                prefMutedNote = "Si vous coupez tout, les suivis continuent mais rien ne vous parvient.",
                display = "Affichage", dataSection = "Données",
                clearRecent = "Effacer les recherches récentes",
                clearRecentSub = "{n} recherches enregistrées sur cet appareil",
                stopAllWatches = "Arrêter tous les suivis", stopAllWatchesSub = "{n} suivis actifs",
                nothingToClear = "Rien à effacer",
                handoverTitle = "Réservation",
                continueOn = "Vous allez continuer sur {site}",
                notSeller = "Qasda compare les prix, il ne vend pas de billets. La réservation et le paiement se font sur le site du vendeur.",
                labelFlight = "Vol", labelRoute = "Trajet", labelDate = "Date",
                labelTravellers = "Voyageurs", labelShownPrice = "Prix affiché",
                priceMayChange = "Le prix peut avoir changé depuis notre dernière vérification. Vérifiez-le sur la page du vendeur avant de payer.",
                openSite = "Ouvrir {site}", backToResults = "Revenir aux résultats",
                priceHistoryTitle = "Historique des prix",
                clearRecentOneSub = "1 recherche enregistrée sur cet appareil",
                stopAllWatchesOneSub = "1 suivi actif",
            )
            Lang.AR -> Words(
                ...
                stopsTwoPlus = "توقفان أو أكثر", baggage = "الأمتعة", anyBaggage = "حقيبة يد فقط",
                navAccount = "الحساب",
                ...
                airlinesOnRoute = "شركات الطيران على هذا المسار",
                fromPrice = "ابتداءً من {price}", allAirlines = "الكل",
                priceChart = "رسم بياني", priceByDate = "السعر حسب التاريخ",
                calendarTab = "تقويم", bookingSites = "مواقع الحجز",
                clearAll = "مسح الكل",
                bagHoldIncluded = "أمتعة مسجلة مشمولة",
                bagHoldSub = "إخفاء الأسعار بدون أمتعة",
                markAllRead = "تعليم الكل كمقروء",
                chartSub = "أدنى سعر في اليوم",
                chartLow = "الأدنى", chartAvg = "المتوسط", chartHigh = "الأعلى",
                chartNote = "بناءً على آخر عمليات الرصد. السعر السابق ليس وعدًا بسعر الغد.",
                showOffers = "عرض {n} عرضًا",
                cheapestOver = "الأرخص في هذه الفترة",
                seeFlightsOn = "عرض رحلات {date}",
                offerDetails = "تفاصيل العرض", itinerary = "خط الرحلة",
                cheaper = "الأرخص", totalTime = "{duration} إجمالاً",
                sameFlightOn = "الرحلة نفسها على {n} مواقع",
                statWatches = "متابعات نشطة", statNotifications = "إشعارات",
                statSearches = "عمليات بحث", currency = "العملة",
                currencyDzd = "دينار جزائري", homeAirport = "مطار المغادرة",
                notSet = "غير محدد",
                timeNow = "الآن", timeHours = "قبل {n} ساعة",
                timeYesterday = "أمس", timeDays = "قبل {n} يوم", timeWeeks = "قبل {n} أسبوع",
                prefDrops = "انخفاض السعر", prefDropsSub = "عندما ينزل سعر رحلة متابَعة تحت السعر الذي رأيته",
                prefSeats = "توفر مقعد", prefSeatsSub = "عندما يعود مقعد إلى رحلة مكتملة",
                prefEnded = "انتهاء المتابعة", prefEndedSub = "عندما يمر تاريخ المتابعة",
                prefMutedNote = "إذا أوقفت كل شيء، تستمر المتابعة لكن لن يصلك أي إشعار.",
                display = "العرض", dataSection = "البيانات",
                clearRecent = "مسح عمليات البحث الأخيرة",
                clearRecentSub = "{n} عمليات بحث محفوظة على هذا الجهاز",
                stopAllWatches = "إيقاف كل المتابعات", stopAllWatchesSub = "{n} متابعات نشطة",
                nothingToClear = "لا شيء لمسحه",
                handoverTitle = "الحجز",
                continueOn = "ستتابع على {site}",
                notSeller = "قصدة يقارن الأسعار ولا يبيع التذاكر. يتم الحجز والدفع على موقع البائع.",
                labelFlight = "الرحلة", labelRoute = "المسار", labelDate = "التاريخ",
                labelTravellers = "المسافرون", labelShownPrice = "السعر المعروض",
                priceMayChange = "قد يكون السعر تغيّر منذ آخر تحقق. تأكد منه على صفحة البائع قبل الدفع.",
                openSite = "فتح {site}", backToResults = "العودة إلى النتائج",
                priceHistoryTitle = "سجل الأسعار",
                clearRecentOneSub = "عملية بحث واحدة محفوظة على هذا الجهاز",
                stopAllWatchesOneSub = "متابعة واحدة نشطة",
            )
            Lang.EN -> Words(
                ...
                bookOn = "Book on {site}",
                stopsTwoPlus = "2 stops or more", baggage = "Baggage", anyBaggage = "Cabin bag only",
                navAccount = "Account",
                ...
                airlinesOnRoute = "Airlines on this route",
                fromPrice = "from {price}", allAirlines = "All",
                priceChart = "Chart", priceByDate = "Price by date",
                calendarTab = "Calendar", bookingSites = "Booking sites",
                clearAll = "Clear all",
                bagHoldIncluded = "Checked bag included",
                bagHoldSub = "Hide fares without a bag",
                markAllRead = "Mark all read",
                chartSub = "lowest price per day",
                chartLow = "Lowest", chartAvg = "Average", chartHigh = "Highest",
                chartNote = "From the readings we have. A past price is not a promise about tomorrow\u2019s.",
                showOffers = "Show the {n} offers",
                cheapestOver = "Cheapest over this period",
                seeFlightsOn = "See flights on {date}",
                offerDetails = "Offer details", itinerary = "Itinerary",
                cheaper = "cheaper", totalTime = "{duration} in total",
                sameFlightOn = "The same flight on {n} sites",
                statWatches = "active alerts", statNotifications = "notifications",
                statSearches = "searches", currency = "Currency",
                currencyDzd = "Algerian dinar", homeAirport = "Home airport",
                notSet = "Not set",
                timeNow = "just now", timeHours = "{n} h ago",
                timeYesterday = "yesterday", timeDays = "{n} d ago", timeWeeks = "{n} w ago",
                prefDrops = "Price drop", prefDropsSub = "When a tracked route goes below the price you saw",
                prefSeats = "Seat freed", prefSeatsSub = "When a seat comes back on a full flight",
                prefEnded = "Tracking ended", prefEndedSub = "When a tracked date has passed",
                prefMutedNote = "Turn everything off and the routes stay tracked, but nothing reaches you.",
                display = "Display", dataSection = "Data",
                clearRecent = "Clear recent searches",
                clearRecentSub = "{n} searches kept on this device",
                stopAllWatches = "Stop all tracking", stopAllWatchesSub = "{n} active",
                nothingToClear = "Nothing to clear",
                handoverTitle = "Booking",
                continueOn = "You are continuing on {site}",
                notSeller = "Qasda compares prices, it does not sell tickets. Booking and payment happen on the seller\u2019s own site.",
                labelFlight = "Flight", labelRoute = "Route", labelDate = "Date",
                labelTravellers = "Travellers", labelShownPrice = "Price shown",
                priceMayChange = "The price may have changed since we last checked. Confirm it on the seller\u2019s page before you pay.",
                openSite = "Open {site}", backToResults = "Back to results",
                priceHistoryTitle = "Price history",
                clearRecentOneSub = "1 search kept on this device",
                stopAllWatchesOneSub = "1 active",
            )
        }
    }
}
